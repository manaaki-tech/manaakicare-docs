...
| Card | Icon | Description | Highlight Color |
|------|------|-------------|-----------------|
...
|--------|-------|---------|
| **awaiting_commencement** | Gray | Episode created but service delivery hasn't started yet |
...
| **discharged** | Outline | Client has been discharged from the service |
...
| **High** | Red | High risk — prioritize this activity |
| **Medium** | Primary (dark) | Moderate risk — monitor closely |
| **None** / other | Gray | No specific risk identified |
...
| **In Xd** | Gray | Follow-up is due in 3+ days (e.g., "In 3d") |
