...
| **Total <Term path="referral" plural />** | Activity | Total number of referrals across all priority levels | Default (no highlight) |
...
- **Total <Term path="referral" plural />** shows your overall referral volume across all priorities (routine, priority, urgent, crisis, emergency)
