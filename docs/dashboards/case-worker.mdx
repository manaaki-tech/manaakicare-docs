...
The Case Worker Dashboard — titled **"<Term path="myCaseload" />"** — is your personal hub for managing assigned <Term path="serviceEpisode" plural /> and tracking activities that need follow-up. It gives you a focused view of your own workload.
...
- **<Term path="myActiveCases" />** table of all service episodes assigned to you
...
|---------|--------------------|-------------------|
| **<Term path="myActiveCases" />** | "Search by client, service, or status..." | Client name, service name, status |
...
1. Find the episode in the **<Term path="myActiveCases" />** table
...
1. **Start of Day**
   ...
   - Scan **<Term path="myActiveCases" />** for episodes awaiting commencement
