...
# <Term path="caseWorker" /> Dashboard

The <Term path="caseWorker" /> Dashboard — titled **"My <Term path="caseload" />"** — is your personal hub for managing assigned <Term path="serviceEpisode" plural /> and tracking activities that need follow-up. It gives you a focused view of your own workload.
...
- **My Active <Term path="cases" />** table of all service episodes assigned to you
...
|------|------|-------------|-----------------|
| **Active <Term path="serviceEpisode" plural />** | Document | Number of active service episodes assigned to you | Blue when you have active cases |
...
- **Active <Term path="serviceEpisode" plural />** reflects your current service episode assignments
...
1. Find the episode in the **My Active <Term path="cases" />** table
...
| Data Type | Scope |
|-----------|-------|
| <Term path="serviceEpisode" plural /> | Only episodes where you are assigned as staff |
...
1. **Start of Day**
   ...
   - Scan **My Active <Term path="cases" />** for episodes awaiting commencement
