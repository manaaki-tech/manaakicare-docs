...
3. If a team member is selected in the "Allocate to Team Member" dropdown:
   ...
   - The case worker will see this episode appear on their [Case Worker Dashboard](/dashboards/case-worker) under **<Term path="myActiveCases" />**
...
| **<Term path="serviceUser" plural /> Needing Contact** | "Search by client or case worker..." | Client name, case worker name |
