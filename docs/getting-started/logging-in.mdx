---
title: Logging In
description: How to log in to ManaakiCare and reset your password
sidebar_position: 1
helpId: login
...
ManaakiCare uses secure authentication to protect client data. You'll need valid credentials provided by your organisation's administrator.

## Accessing ManaakiCare

1. Open your web browser
2. Navigate to your organisation's ManaakiCare URL
